...
- **[Architecture & Design](docs/INDEX.md#architecture--design)** - Understanding the I Ching state system
- **[API Reference](docs/INDEX.md#api-reference)** - CLI commands, shell projection, Web API
- **[Contributing Guide](CONTRIBUTING.md)** - Development setup and onboarding

New to OneCode? Start with the [I Ching system overview](docs/INDEX.md#understanding-the-i-ching-state-system) to understand how the 64-state control flow works.
