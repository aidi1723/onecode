...
function createMCPServerMethods(mongoose) {
     ...
     */
    async function findNextAvailableServerName(baseName, reservedServerNames = new Set()) {
        ...
        const existingNames = new Set([
            ...
            ...Array.from(reservedServerNames).filter((serverName) => matchingNamePattern.test(serverName)),
        ]);
    ...
    async function createMCPServer(data) {
        ...
        const MCPServer = mongoose.models.MCPServer;
        let lastError;
        const reservedServerNames = new Set((_a = data.reservedServerNames) !== null && _a !== void 0 ? _a : []);
