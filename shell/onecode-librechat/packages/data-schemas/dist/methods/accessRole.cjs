...
require('../common/permissions.cjs');
...
function createAccessRoleMethods(mongoose) {
    ...
    async function seedDefaultRoles() {
        ...
        const defaultRoles = [
            ...
            {
                accessRoleId: librechatDataProvider.AccessRoleIds.SKILL_VIEWER,
                name: 'com_ui_role_viewer',
                description: 'com_ui_role_viewer_desc',
            ...
            {
                accessRoleId: librechatDataProvider.AccessRoleIds.SKILL_EDITOR,
                name: 'com_ui_role_editor',
                description: 'com_ui_role_editor_desc',
                resourceType: librechatDataProvider.ResourceType.SKILL,
                permBits: _enum.RoleBits.EDITOR,
            ...
            {
                accessRoleId: librechatDataProvider.AccessRoleIds.SKILL_OWNER,
                name: 'com_ui_role_owner',
                description: 'com_ui_role_owner_desc',
                resourceType: librechatDataProvider.ResourceType.SKILL,
                permBits: _enum.RoleBits.OWNER,
