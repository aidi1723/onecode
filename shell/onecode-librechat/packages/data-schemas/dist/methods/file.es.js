...
import { FileContext, EToolResources } from 'librechat-data-provider';
...
function createFileMethods(mongoose) {
    ...
    async function sweepOrphanedPreviews(maxAgeMs = 5 * 60 * 1000) {
        ...
        if (result.modifiedCount > 0) {
            logger.info(`[sweepOrphanedPreviews] Marked ${result.modifiedCount} stale 'pending' files as 'failed' (cutoff: ${cutoff.toISOString()})`);
        }
