 ...
 */
const MAX_PERM_BITS = Object.values(librechatDataProvider.PermissionBits)
 ...
 */
if (MAX_PERM_BITS === 0) {
    throw new Error('MAX_PERM_BITS is 0 — `PermissionBits` did not yield any numeric members. ' +
...
if (MAX_PERM_BITS > 255) {
    throw new Error(`MAX_PERM_BITS=${MAX_PERM_BITS} exceeds the $in-enumeration ceiling of 255. ` +
...
exports.MAX_PERM_BITS = MAX_PERM_BITS;
