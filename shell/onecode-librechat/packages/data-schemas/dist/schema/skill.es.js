...
const SKILL_BODY_MAX_LENGTH = 100000;
...
const skillSchema = new Schema({
    ...
    name: {
        ...
        validate: {
            ...
            message: 'Name must be kebab-case (lowercase letters, digits, hyphens), cannot start with "anthropic-" or "claude-", and cannot be a reserved CLI word.',
        },
    },
    /**
