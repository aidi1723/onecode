...
const skillFileSchema = new Schema({
    skillId: {
    ...
    relativePath: {
        ...
        validate: {
            ...
            message: 'Relative path must be relative, cannot contain ".." or absolute paths, and cannot be SKILL.md.',
        },
    },
    file_id: {
        type: String,
...
export { skillFileSchema as default };
