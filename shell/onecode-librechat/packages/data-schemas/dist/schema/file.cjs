...
file.index({ filename: 1, conversationId: 1, context: 1, tenantId: 1 }, { unique: true, partialFilterExpression: { context: librechatDataProvider.FileContext.execute_code } });
