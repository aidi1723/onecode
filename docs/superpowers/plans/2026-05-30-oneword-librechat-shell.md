...
- Use `<local-user-path>` as the working shell repository unless the user chooses another path before execution.
...
- Create sibling repo: `<local-user-path>`
- Modify: `<local-user-path>`
...
- Create: `<local-user-path>`
- Create: `<local-user-path>`
- Modify later if needed: `<local-user-path>`
- Modify later if needed: `<local-user-path>`

### Task 1: Create And Pin The LibreChat Fork

**Files:**
- Create/modify repository: `<local-user-path>`
- Read: `<local-user-path>`
- Create: `<local-user-path>`
...
Modify the UI section of `<local-user-path>` so it contains:
...
In `<local-user-path>`, add to `scripts`:
...
**Files:**
- Read/execute: `<local-user-path>`
- Read/execute: `<local-user-path>`
- Execute: `<local-user-path>`
...
**Files:**
- Review: `<local-user-path>`
- Review: `<private-development-workspace>/docs/superpowers/specs/2026-05-30-oneword-librechat-shell-design.md`
