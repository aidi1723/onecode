...
import scripts.serve_yizijue_mlx as serve_module
...
class ServeYiZiJueMlxTest(unittest.TestCase):
    ...
    def test_release_tests_import_release_service_module(self):
        module_path = Path(serve_module.__file__).resolve()

        self.assertIn("release/yizijue-lm-public/scripts", module_path.as_posix())
