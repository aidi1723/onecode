    ...
    for tool_call in step.tool_calls:
        ...
        try:
            ...
            if tool.runner_managed:
                ...
                command_failed = tool.name == "run_command" and output.get("returncode") != 0
                result = {
                    "status": "halted" if command_failed else "completed",
                    "reason": "command_nonzero_exit" if command_failed else None,
